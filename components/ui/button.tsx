...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[14px] text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-navy-700 to-navy-600 text-primary-foreground hover:opacity-95 shadow-[0_16px_28px_-18px_rgba(31,48,105,0.75)]",
        destructive:
        ...
        climb: "bg-gradient-to-r from-saffron-500 to-gold-500 text-climb-foreground hover:opacity-95 shadow-[0_16px_28px_-18px_rgba(25,213,109,0.82)]",
      },
      size: {
